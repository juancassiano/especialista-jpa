...
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (2, 3, 1400, 1;
...
insert into nota_fiscal (pedido_id, xml, data_emissao) values (2, '<xml />', date_sub(sysdate(), interval 1 hour));
